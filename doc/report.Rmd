...
Based on the plot, our model performes well in predicting wine whose grades are on the middle range (grades 5 to 7). However, for the low-graded and high-graded wines (wine with grades 4 and 8), the model tends to under-estimate the grades.
...
The reason that it did not perform well on low-graded and high-graded wines may be due to that the original training set is not balanced enough, the data set does have more examples for the middle-graded wines and fewer examples for low and high grade wines, which means our model can not ‘learn’ enough from the low-graded and high-graded wines.
